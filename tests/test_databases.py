...
from ngiridb import Database, DatabaseURL
...
def create_test_database():
    # Create test ngiridb with tables creation
    ...
    # Run garbage collection to ensure any in-memory ngiridb are dropped
    gc.collect()
...
async def test_transaction_context_cleanup_contextmanager(database_url):
    ...
    """
    from ngiridb.core import _ACTIVE_TRANSACTIONS
...
@async_adapter
async def test_connection_context_multiple_ngiridb(database_url1, database_url2):
...
def test_global_connection_is_initialized_lazily(database_url):
    ...
    See https://github.com/encode/ngiridb/issues/157 for more context.
    """
