...
from ngiridb.backends.aiopg import AiopgBackend
from ngiridb.backends.postgres import PostgresBackend
from ngiridb.core import DatabaseURL
from tests.test_ngiridb import DATABASE_URLS, async_adapter

if sys.version_info >= (3, 7):  # pragma: no cover
    from ngiridb.backends.asyncmy import AsyncMyBackend


if sys.version_info < (3, 10):  # pragma: no cover
    from ngiridb.backends.mysql import MySQLBackend
